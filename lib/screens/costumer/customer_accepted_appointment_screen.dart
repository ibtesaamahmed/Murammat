...
class CustomerAcceptedAppointmentScreen extends StatefulWidget {
  const CustomerAcceptedAppointmentScreen({super.key});

  @override
  State<CustomerAcceptedAppointmentScreen> createState() =>
      _CustomerAcceptedAppointmentScreenState();
}

class _CustomerAcceptedAppointmentScreenState
    extends State<CustomerAcceptedAppointmentScreen> {
